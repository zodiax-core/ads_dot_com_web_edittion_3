...
export const Route = createFileRoute("/services/printing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Wide-format printing, architectural graphics & specialty inks in Lahore. Up to 12m continuous format. Get a quote from ADS DOT COM — 100% in-house press." },
      { property: "og:title", content: "Printing Services in Lahore | ADS DOT COM" },
      { property: "og:description", content: "Wide-format, letterpress, foil and reactive inks. Up to 12m continuous print format. In-house press. Get a quote from ADS DOT COM Lahore." },
  ...
  return (
    <ServicePage
      data={{
        ...
        stats: [
          { v: "12m", l: "Max Continuous Format" },
          { v: "4", l: "Ink Technologies" },
          { v: "100%", l: "In-house Press" },
        ],
        faqs: [
          {
          ...
          "@graph": [
            {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "Printing", "item": "https://adsdotcom.net/services/printing" },
              ],
            },
            {
              "@type": "Service",
            ...
            },
            {
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "What is the fastest turnaround for a print job in Lahore?", "acceptedAnswer": { "@type": "Answer", "text": "For wide-format vinyl with approved artwork, we can deliver within 48 hours. Standard turnaround is 3–5 working days." } },
                { "@type": "Question", "name": "Do you offer colour proofing before full production runs?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We produce physical material proofs at full colour density before any full production run. Client sign-off is required before we proceed." } },
                { "@type": "Question", "name": "What file formats do you accept for print-ready artwork?", "acceptedAnswer": { "@type": "Answer", "text": "We accept PDF (print-ready, CMYK, minimum 100dpi at final print size), AI, EPS and TIFF." } },
                { "@type": "Question", "name": "Can you print on non-standard materials or shapes?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. We regularly print on aluminium composite, correx board, backlit film, mesh banner and fabric." } },
              ],
            },
          ],
        },
