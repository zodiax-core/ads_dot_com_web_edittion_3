...
//#region node_modules/.nitro/vite/services/ssr/assets/process-DJhQUmMT.js
...
var steps = [
	{
		...
		faqs: [{
			...
			a: "Yes. We manage municipal and cantonment permit applications on your behalf for all outdoor installations."
		}, {
			q: "What if the site has access restrictions?",
			a: "We work with your facilities team to schedule access windows, including overnight or weekend slots."
		}]
	},
	{
		n: "02",
		...
		faqs: [{
			q: "How many design concepts do we receive?",
			a: "We present one fully developed concept per brief, refined through your feedback rather than offering multiple competing options."
		}, {
			q: "Can we request revisions?",
			a: "Yes. The draft phase includes two rounds of design revisions at no additional cost."
		}]
	},
	{
		n: "03",
		...
		faqs: [{
			q: "What if we want to change materials at this stage?",
			a: "Material changes at prototype stage are accommodated. Changes post sign-off may incur revision costs."
		}, {
			q: "Do we keep the prototype samples?",
			a: "Yes. Physical samples are packaged and couriered to your team for records."
		}]
	},
	{
		n: "04",
		...
		faqs: [{
			q: "What is your fastest turnaround for print-only jobs?",
			a: "For straightforward wide-format print jobs with approved artwork, we can deliver within 48 hours."
		}, {
			q: "Do you provide post-installation maintenance?",
			a: "Yes. We offer scheduled maintenance visits and rapid-response repairs for all installed structures."
		}]
	}
];
var guarantees = [
	{
		...
		desc: "Every phase is handled by our own team — print, fab, rigging. One point of accountability."
	},
	{
		icon: "📐",
		title: "Prototype before production",
		desc: "You approve physical samples before we run a single metre of material. No surprises on site."
	},
	{
		icon: "⏱️",
		title: "Committed timelines",
		desc: "We anchor project milestones in the contract. Delays on our side trigger agreed remedies."
	},
	{
		icon: "🔧",
		title: "Post-install support",
		desc: "We don't disappear after handover. Maintenance, repairs and site visits are part of our service."
	}
];
function ProcessPage() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(PageShell, { children: [
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1 rounded-full bg-accent-mint" }), " How We Work"]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Every project moves through the same four-stage rhythm — no handoffs, no lost detail, no subcontractors between you and the finished result."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-10 flex flex-wrap justify-center gap-3 animate-reveal-up",
							style: { animationDelay: "240ms" },
							children: steps.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								onClick: () => document.getElementById(`step-${s.n}`)?.scrollIntoView({
									behavior: "smooth",
									block: "center"
								}),
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `size-2 rounded-full bg-${s.accent}` }),
									s.n,
									" · ",
									s.title
								]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "max-w-5xl mx-auto px-4 py-20 space-y-6",
			children: steps.map((s, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				id: `step-${s.n}`,
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: `relative flex flex-col md:flex-row items-start gap-6 p-8 border-b border-ink/5`,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `shrink-0 size-14 rounded-2xl bg-${s.accent}/10 border border-${s.accent}/20 flex flex-col items-center justify-center`,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: `text-[10px] font-bold uppercase tracking-widest text-${s.accent}`,
								children: s.n
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: `text-[10px] font-bold uppercase tracking-[0.2em] text-${s.accent} mb-1`,
									children: ["Phase ", s.n]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
									className: "text-2xl md:text-3xl font-serif italic font-medium text-ink",
									children: s.title
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm text-ink-mute mt-1",
									children: s.subtitle
								})
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-[10px] uppercase font-bold tracking-wider text-ink-mute",
									children: "Duration"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "p-8 grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-10",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-ink-soft leading-relaxed mb-6",
						children: s.description
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-[10px] uppercase font-bold tracking-wider text-ink-mute mb-3",
							children: "Common Questions"
						}), s.faqs.map((faq) => {
							const key = `${s.n}-${faq.q}`;
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "rounded-2xl border border-ink/5 overflow-hidden",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: `size-4 text-ink-mute shrink-0 transition-transform ${openFaq === key ? "rotate-180" : ""}`,
										viewBox: "0 0 24 24",
										fill: "none",
										stroke: "currentColor",
										strokeWidth: 2,
									...
									className: `overflow-hidden transition-all duration-300 ${openFaq === key ? "max-h-40" : "max-h-0"}`,
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "px-4 pb-4 text-sm text-ink-soft leading-relaxed",
										children: faq.a
									})
								})]
							}, faq.q);
						...
						className: "bg-surface rounded-[1.5rem] p-6",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-[10px] uppercase font-bold tracking-widest text-ink-mute mb-4",
								children: "Key Outputs"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
								className: "space-y-3",
								children: s.outputs.map((o, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
									className: "flex items-start gap-3",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `mt-1.5 size-1.5 rounded-full bg-${s.accent} shrink-0` }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "mt-6 pt-5 border-t border-ink/5",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "text-[10px] uppercase font-bold tracking-widest text-ink-mute mb-2",
									children: "Phase Connector"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs text-ink-mute leading-relaxed",
									children: idx < steps.length - 1 ? `Phase ${s.n} concludes with a client approval gate before ${steps[idx + 1].title} begins.` : "Phase 04 concludes with a handover inspection and signed completion certificate."
								})]
							})
						]
					})]
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
			className: "px-4 py-20 bg-surface border-t border-ink/5",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: ["Zero shortcuts. ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: guarantees.map((g) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "p-6 bg-canvas rounded-[1.75rem] border border-ink/5 shadow-soft hover:shadow-lift transition-shadow duration-500",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
						...
						children: [
							"Phase 01 starts with",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-serif italic text-accent-blue",
								children: "a site visit."
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-ink-soft text-sm max-w-md mx-auto mb-8 leading-relaxed",
						children: "We'll assess your space or brief at no charge and give you an honest scope and timeline before any commitment."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
