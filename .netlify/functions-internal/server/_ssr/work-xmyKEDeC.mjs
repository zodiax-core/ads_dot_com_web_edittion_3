...
import { n as project_monolith_default, t as project_lumos_default } from "./project-monolith-DDC7IuZS.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/work-xmyKEDeC.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var printing_default = "/assets/printing--Aq6Hz5C.jpg";
var events_default = "/assets/events-Fjb1wdLh.jpg";
...
function GlobalGallery() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [lightbox && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lightbox, {
		...
		className: "columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 space-y-4",
		children: images.map((img) => img ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
