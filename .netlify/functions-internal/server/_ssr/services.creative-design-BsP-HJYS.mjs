					...
					"mainEntity": [
						{
							...
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "A focused brand identity project typically takes 3–5 weeks. Larger programmes including environmental design and packaging can take 8–12 weeks."
							}
						},
						{
							"@type": "Question",
							"name": "Do you provide print-ready files or only creative concepts?",
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "We deliver fully print-ready, production-ready files alongside the creative work."
							}
						},
						{
							"@type": "Question",
							"name": "Can you redesign an existing brand rather than start from scratch?",
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "Yes. Brand refresh and evolution projects are a significant part of our studio work."
							}
						}
					]
				}
...
//#endregion
export { CreativeDesignPage as component };
