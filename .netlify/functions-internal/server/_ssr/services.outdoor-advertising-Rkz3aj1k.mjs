			...
			"@graph": [
				{
					...
					"itemListElement": [
						...
						},
						{
							...
							"item": "https://adsdotcom.net/services/outdoor-advertising"
						}
					]
				},
				{
				...
				},
				{
					...
					"mainEntity": [
						{
							"@type": "Question",
							"name": "How long does it take to produce and install a billboard in Lahore?",
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "For a standard single-face billboard with approved artwork, production and installation typically takes 5–10 working days. Rush jobs with 48-hour print turnaround are available."
							}
						},
						{
							"@type": "Question",
							"name": "Do you handle permit applications for outdoor sites?",
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "Yes. We manage cantonment and municipal permit applications on your behalf for all outdoor installations in Lahore. Timelines vary by authority — typically 1–3 weeks."
							}
						},
						{
							"@type": "Question",
							"name": "What areas do you cover for outdoor advertising?",
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "We operate primarily across Lahore, with installations also completed in Karachi, Islamabad, Rawalpindi and other major cities."
							}
						},
						{
							"@type": "Question",
							"name": "What is the minimum campaign size for outdoor advertising?",
							"acceptedAnswer": {
								"@type": "Answer",
								"text": "We work with single-site campaigns as well as multi-city circuits. There is no fixed minimum — send us your brief and we'll advise on what makes sense for your budget."
							}
						}
					]
				}
...
//#endregion
export { OutdoorAdvertisingPage as component };
